...
window.onload = () => {
  ...
  const progressBars = [
    ...
    { progress: 86, barId: 'cdsa-progress', percentId: 'cdsa-percent' },
    ...
    { barId: 'jsads-progress', percentId: 'jsads-ratio', isProjectCert: true, completedProjects: 15, totalProjects: 25 },
