...
window.onload = () => {
  ...
  const progressBars = [
    ...
    { progress: 63, barId: 'cdsa-progress', percentId: 'cdsa-percent' },
    ...
    { barId: 'jsads-progress', percentId: 'jsads-ratio', isProjectCert: true, completedProjects: 3, totalProjects: 25 },
