...
window.onload = () => {
  ...
  const progressBars = [
    ...
    { progress: 70, barId: 'cdsa-progress', percentId: 'cdsa-percent' },
    ...
    { barId: 'jsads-progress', percentId: 'jsads-ratio', isProjectCert: true, completedProjects: 10, totalProjects: 25 },
