...
window.onload = () => {
  ...
  const progressBars = [
    ...
    { progress: 76, barId: 'cdsa-progress', percentId: 'cdsa-percent' },
    ...
    { barId: 'jsads-progress', percentId: 'jsads-ratio', isProjectCert: true, completedProjects: 12, totalProjects: 25 },
