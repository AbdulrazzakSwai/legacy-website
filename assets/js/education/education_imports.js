...
window.onload = () => {
  ...
  const progressBars = [
    ...
    { progress: 62, barId: 'cdsa-progress', percentId: 'cdsa-percent' },
    ...
    { barId: 'jsads-progress', percentId: 'jsads-ratio', isProjectCert: true, completedProjects: 2, totalProjects: 25 },
