...
window.onload = () => {
  ...
  const progressBars = [
    ...
    { progress: 72, barId: 'cdsa-progress', percentId: 'cdsa-percent' },
    ...
    { barId: 'jsads-progress', percentId: 'jsads-ratio', isProjectCert: true, completedProjects: 11, totalProjects: 25 },
