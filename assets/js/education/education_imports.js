...
window.onload = () => {
  ...
  const progressBars = [
    ...
    { progress: 69, barId: 'cdsa-progress', percentId: 'cdsa-percent' },
    ...
    { barId: 'jsads-progress', percentId: 'jsads-ratio', isProjectCert: true, completedProjects: 6, totalProjects: 25 },
