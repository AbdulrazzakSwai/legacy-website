...
window.onload = () => {
  ...
  const progressBars = [
    ...
    { progress: 84, barId: 'cdsa-progress', percentId: 'cdsa-percent' },
    ...
    { barId: 'jsads-progress', percentId: 'jsads-ratio', isProjectCert: true, completedProjects: 14, totalProjects: 25 },
