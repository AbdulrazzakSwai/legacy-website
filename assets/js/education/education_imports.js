...
window.onload = () => {
  ...
  const progressBars = [
    ...
    { progress: 95, barId: 'cbbh-progress', percentId: 'cbbh-percent' },
    ...
    { barId: 'jsads-progress', percentId: 'jsads-ratio', isProjectCert: true, completedProjects: 17, totalProjects: 25 },
